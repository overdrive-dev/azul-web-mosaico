    ...
    <main className="min-h-screen">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="order-first lg:order-none lg:w-1/2">
            <div className="relative aspect-square lg:aspect-auto lg:h-[50vw] w-full bg-gray-200">
              <Image src="/images/grades-piso-1.jpg" alt="Grades de piso em ambiente industrial" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="order-first lg:order-none lg:w-1/2">
            <div className="relative aspect-square lg:aspect-auto lg:h-[50vw] w-full bg-gray-200">
              <Image src="/images/grades-piso-3.jpg" alt="Passarela com grades de piso" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
