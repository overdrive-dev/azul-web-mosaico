    ...
    <main className="min-h-screen">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="order-first lg:order-none lg:w-1/2">
            <div className="relative aspect-square lg:aspect-auto lg:h-[50vw] w-full bg-gray-200">
              <SkeletonImage src="/images/bandejamento-1.jpg" alt="Sistema de bandejamento em fibra de vidro" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="flex flex-col lg:flex-row">
          <div className="lg:order-1 lg:w-1/2">
            <div className="relative aspect-square lg:aspect-auto lg:h-[50vw] w-full bg-gray-200">
              <SkeletonImage src="/images/bandejamento-2.png" alt="Leitos de cabos" fill className="object-cover" />
            </div>
          </div>
      ...
      <section className="bg-white">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="order-first lg:order-none lg:w-1/2">
            <div className="relative aspect-square lg:aspect-auto lg:h-[50vw] w-full bg-gray-200">
              <SkeletonImage src="/images/bandejamento-3.png" alt="Eletrocalhas em fibra de vidro" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="flex flex-col lg:flex-row">
          <div className="lg:order-1 lg:w-1/2">
            <div className="relative aspect-square lg:aspect-auto lg:h-[50vw] w-full bg-gray-200">
              <SkeletonImage src="/images/bandejamento-4.png" alt="Bandejamento e leitos" fill className="object-cover" />
            </div>
          </div>
          <div className="flex items-center px-6 py-16 sm:py-24 lg:order-2 lg:w-1/2 lg:px-12 lg:py-32">
            <div className="mx-auto max-w-md">
