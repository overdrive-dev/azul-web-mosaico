    ...
    <header className="sticky top-0 z-50 bg-azul-800">
      ...
      <Transition show={mobileMenuOpen}>
        <Dialog onClose={setMobileMenuOpen} className="relative z-50 lg:hidden">
          ...
          >
            <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-azul-800 p-6 sm:max-w-sm sm:shadow-xl">
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-white/10">
                  ...
                  <div className="py-6">
                    <h3 className="text-xs font-semibold text-azul-300 uppercase tracking-wide mb-3">Produtos</h3>
                    <div className="space-y-1">
                      {products.map((item) => (
                        <a
                          ...
                          href={item.href}
                          onClick={() => setMobileMenuOpen(false)}
                          className="-mx-3 block rounded-lg px-3 py-2 text-sm text-azul-200 hover:bg-white/10 hover:text-white"
                        >
                          {item.name}
                        </a>
                      ))}
                  ...
                  <div className="py-6">
                    <h3 className="text-xs font-semibold text-azul-300 uppercase tracking-wide mb-3">Contato</h3>
                    <a
                      href="https://wa.me/5521973583171"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="-mx-3 flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10"
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-azul-300">+55 21 97358-3171</div>
                      </div>
                    </a>
                    <a
                      href="mailto:vendas@azulcompositos.com.br"
                      className="-mx-3 flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-white/10 mt-1"
                    >
                      <svg className="size-5 text-azul-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                      </svg>
                      <div>
                        <div className="text-sm font-medium text-white">E-mail</div>
                        <div className="text-xs text-azul-300">vendas@azulcompositos.com.br</div>
                      </div>
                    </a>
                  </div>
                </div>
